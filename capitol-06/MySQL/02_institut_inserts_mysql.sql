...
--  MÒDULS
-- ------------------------------------------------------------
--  Codis CHAR(6). Hores entre 30 i 300. Curs 1 o 2.
--  El mòdul 'ADM201 - Gestió logística' es deixa SENSE professor (NULL)
--  per practicar LEFT JOIN i la diferència entre INNER i OUTER JOINs.
INSERT INTO modul (id_modul, codi, nom_modul, hores, curs, id_prof) VALUES
    -- Informàtica
    ( 1, 'INF101', 'Bases de dades',                  165, 1,  1),  -- Héctor
    ( 2, 'INF102', 'Programació',                     297, 1,  2),  -- Marta
    ( 3, 'INF103', 'Llenguatges de marques',           99, 1,  3),  -- Jordi
    ( 4, 'INF104', 'Entorns de desenvolupament',       66, 1,  4),  -- Eva (inactiva)
    ( 5, 'INF105', 'Sistemes informàtics',            165, 1,  2),  -- Marta
    ( 6, 'INF201', 'Accés a dades',                   132, 2,  1),  -- Héctor
    ( 7, 'INF202', 'Desenvolupament d''interfícies',  132, 2,  3),  -- Jordi
    -- Disseny
    ( 8, 'DIS101', 'Tipografia',                       99, 1,  5),  -- Dori
    ( 9, 'DIS102', 'Dibuix artístic',                 132, 1,  6),  -- Anna
    (10, 'DIS201', 'Disseny gràfic editorial',        165, 2,  5),  -- Dori
    -- Anglès (transversal)
    (11, 'ENG101', 'Anglès tècnic I',                  99, 1,  7),  -- Ramón
    (12, 'ENG201', 'Anglès tècnic II',                 99, 2,  8),  -- Sergi
    -- Orientació Laboral / FOL
    (13, 'FOL101', 'Formació i orientació laboral',    99, 1,  9),  -- Isabel
    (14, 'FOL201', 'Empresa i iniciativa emprenedora', 66, 2,  9),  -- Isabel
    -- Sanitat
    (15, 'SAN101', 'Anatomia patològica',             132, 1, 10),  -- Pere
    (16, 'SAN201', 'Biologia molecular',              165, 2, 10),  -- Pere
    -- Electrònica
    (17, 'ELE101', 'Electrònica analògica',           165, 1, 13),  -- Carles
    (18, 'ELE201', 'Electrònica digital',             132, 2, 13),  -- Carles
    -- Administració
    (19, 'ADM101', 'Comptabilitat',                   132, 1, 12),  -- Núria
    (20, 'ADM201', 'Gestió logística',                 99, 2, NULL); -- sense professor
